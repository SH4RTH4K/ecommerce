...
Route::get('/manage-manufacturers', "SuperAdminController@manageManufacturer");
...
Route::delete('/product-code-configuration/{id}', 'ProductCodeConfigurationController@destroy')->name('product-code-configuration.destroy');
 ...
 Route::post('/admin/system/application-update/publish-public-assets', 'SuperAdminController@publishApplicationPublicAssets')->name('admin.application-update.publish-public-assets');
