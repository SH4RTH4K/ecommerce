...
Route::get('/payment-methods', 'SuperAdminController@paymentMethods');
Route::post('/payment-methods', 'SuperAdminController@savePaymentMethod');
Route::post('/payment-methods/{id}/toggle', 'SuperAdminController@togglePaymentMethod');
