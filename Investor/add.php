...
$login=new Doctor();
 ...
 if(isset($_POST['submit'])){
             ...
             $login = $login->save_payment($_POST);
                              //print_r($login);
...
<div class="p-5 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Payment History</h5>
                        <h1 class="text-white mb-4">ADD</h1>
                        <form method ="post">
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input type="date" class="form-control datetimepicker-input" id="datetime" name ="createdDate">
