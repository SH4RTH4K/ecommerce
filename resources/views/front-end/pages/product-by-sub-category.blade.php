...
<section class="lt-section lt-listing-page" style="padding-top:0">
    ...
    <div class="lt-catalog-layout">
        <aside class="lt-filter-panel">
            <form method="get">
                <div class="lt-filter-title"><h2>Filter products</h2><a href="{{ url('/product-by-sub-category/'.$search_by_sub_category_name->sub_category_id) }}">Reset</a></div>
