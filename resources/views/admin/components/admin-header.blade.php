<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="{{ route('admin.dashboard') }}">@if($hasCustomBrandLogo)<img src="{{ asset($brandLogo) }}" alt="" style="max-width:34px;max-height:28px;object-fit:contain;margin-right:7px">@endif<span>{{ $brandName }} Admin</span></a>
