        ...
        <div class="container-fluid">
            ...
            <div class="nav-no-collapse header-nav">
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn dropdown-toggle" data-toggle="dropdown" href="#" aria-label="Administrator menu"><i class="halflings-icon white user"></i> {{ session('admin_name') }} <span class="caret"></span></a>
