            ...
            <div class="box-content">
                ...
                <fieldset class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls"><textarea name="specifications" id="specifications" class="span6" rows="12" placeholder="[Basic Information]&#10;Processor: Intel Core i5&#10;Memory: 16GB"></textarea><p><button type="button" class="btn btn-small" id="load-spec-template"><i class="icon-list-alt"></i> Load category template</button> <span id="spec-template-status" class="help-inline"></span></p><p class="help-block">Paste a specification table from a product page or Word and its sections and rows will be converted automatically. Manual format: <strong>[Section]</strong>, then one <strong>Label: Value</strong> per line.</p><p><span id="specification-paste-status" class="help-inline" aria-live="polite"></span></p></div>
                    </div>
                    <div class="control-group hidden-phone">
                        <label class="control-label" for="textarea2" >Product Description</label>
                        <div class="controls">
                            <textarea name="product_description" class="cleditor product-description-editor" rows="3" data-rich-paste="true"></textarea>
