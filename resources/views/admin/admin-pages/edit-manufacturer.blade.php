            ...
            <div class="box-content">
                ...
                <fieldset class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="company_id" name="company_id" class="span6">
                                ...
                                <option value="{{ $company->id }}" {{ old('company_id', $manufacturer_info->company_id) == $company->id ? 'selected' : '' }}>{{ $company->name }}{{ $company->company_code ? ' - '.$company->company_code : '' }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls"><input type="text" name="brand_code" id="brand_code" value="{{ old('brand_code', $manufacturer_info->brand_code) }}" class="span3" maxlength="30" placeholder="Example: SAM"><p class="help-block">Optional. Keep the current code or change it for a new naming rule.</p></div>
                    </div>
