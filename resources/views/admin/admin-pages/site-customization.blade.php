                        ...
                        <div class="ws-grid">
                            ...
                            <div class="ws-field full {{ $errors->has('site_name_font_size') ? 'has-error' : '' }}">
                                ...
                                <div class="ws-tagline-customizer">
                                    ...
                                    <div class="ws-tagline-preview ws-name-preview" data-name-preview aria-live="polite">{{ $setting('site_name', config('app.name')) }}</div>
                                </div>
