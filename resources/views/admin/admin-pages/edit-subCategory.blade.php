    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                <form action="{{ url('/update-subCategory') }}" method="POST" name="edit_subCategory">
                    @csrf
                <fieldset class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls"><input type="text" name="sub_category_code" id="sub_category_code" value="{{ old('sub_category_code', $subCategory_info->subcategory_code) }}" class="span3" maxlength="30" placeholder="Example: GAM"><p class="help-block">Optional. Keep the current code or change it for new naming rules.</p></div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ url('/manage-subCategory') }}" class="btn">Cancel</a>
                    </div>
