...
class StorefrontThemeService
{
    ...
    public function fieldGroups(): array
    {
        ...
        return [
            ...
            'detail_code' => [
                'label' => 'Product Detail Code Badge',
                'description' => 'Controls the product-code badge shown above the product title on product detail pages.',
                'fields' => [
                    ['key' => 'detail_code_font_family', 'label' => 'Font', 'type' => 'select', 'default' => 'inherit', 'options' => ['inherit' => 'Use Page Text Font'] + $fontFamilies, 'help' => 'Choose the typeface used for the product code.'],
                    ['key' => 'detail_code_font_size', 'label' => 'Text Size', 'type' => 'select', 'default' => '11', 'options' => $fontSizes, 'help' => 'Controls the product-code text size.'],
                    ['key' => 'detail_code_font_weight', 'label' => 'Font Weight', 'type' => 'select', 'default' => '800', 'options' => ['400' => 'Regular', '500' => 'Medium', '600' => 'Semi-bold', '700' => 'Bold', '800' => 'Extra bold', '900' => 'Black'], 'help' => 'Controls how bold the code appears.'],
                    ['key' => 'detail_code_letter_spacing', 'label' => 'Letter Spacing', 'type' => 'select', 'default' => '0.08', 'options' => ['0' => 'Normal', '0.02' => 'Slight', '0.04' => 'Medium', '0.08' => 'Wide', '0.12' => 'Extra wide'], 'help' => 'Changes the spacing between code characters.'],
                    ['key' => 'detail_code_text_transform', 'label' => 'Text Style', 'type' => 'select', 'default' => 'uppercase', 'options' => ['none' => 'As entered', 'uppercase' => 'UPPERCASE'], 'help' => 'Choose whether the label is automatically capitalized.'],
                    ['key' => 'detail_code_text_color', 'label' => 'Text Color', 'type' => 'color', 'default' => '#14708a', 'help' => 'Text color of the product-code badge.'],
                    ['key' => 'detail_code_background', 'label' => 'Background Color', 'type' => 'color', 'default' => '#eef7fb', 'help' => 'Background color of the product-code badge.'],
                    ['key' => 'detail_code_border_color', 'label' => 'Border Color', 'type' => 'color', 'default' => '#eef7fb', 'help' => 'Border color around the product-code badge.'],
                    ['key' => 'detail_code_border_width', 'label' => 'Border Width', 'type' => 'select', 'default' => '0', 'options' => ['0' => 'No border', '1' => '1 px', '2' => '2 px', '3' => '3 px'], 'help' => 'Controls the visible border thickness.'],
                    ['key' => 'detail_code_border_radius', 'label' => 'Corner Shape', 'type' => 'select', 'default' => '999', 'options' => ['0' => 'Square', '4' => 'Slightly rounded', '8' => 'Rounded', '12' => 'More rounded', '16' => 'Soft pill', '999' => 'Full pill'], 'help' => 'Controls how rounded the badge corners are.'],
                    ['key' => 'detail_code_padding_y', 'label' => 'Vertical Padding', 'type' => 'select', 'default' => '5', 'options' => ['2' => '2 px', '3' => '3 px', '5' => '5 px', '7' => '7 px', '9' => '9 px'], 'help' => 'Controls space above and below the code.'],
                    ['key' => 'detail_code_padding_x', 'label' => 'Horizontal Padding', 'type' => 'select', 'default' => '9', 'options' => ['5' => '5 px', '7' => '7 px', '9' => '9 px', '12' => '12 px', '16' => '16 px'], 'help' => 'Controls space on the left and right of the code.'],
                ],
            ],
            'topbar' => [
    ...
    public function presetOptions(): array
    {
        return [
            ...
            'emerald-market' => 'Emerald Market',
            'royal-purple' => 'Royal Purple',
            'crimson-shop' => 'Crimson Shop',
            'amber-night' => 'Amber Night',
            'rose-boutique' => 'Rose Boutique',
            'teal-studio' => 'Teal Studio',
    ...
    public function presetPalettes(): array
    {
        return [
            ...
            'ocean-blue' => [
                'global_primary' => '#075985',
                'global_secondary' => '#082f49',
                'global_accent' => '#06b6d4',
                'global_success' => '#16a34a',
                'global_warning' => '#f59e0b',
                'global_danger' => '#dc2626',
                'global_info' => '#0ea5e9',
                'global_neutral_dark' => '#0c2838',
                'global_neutral_light' => '#e0f2fe',
                'global_page_background' => '#f8fdff',
                'global_body_text' => '#0c2838',
                'global_body_muted' => '#526d7a',
                'global_heading' => '#075985',
                'global_link' => '#0369a1',
                'global_link_hover' => '#0891b2',
                'global_border' => '#bae6fd',
            ],
            'emerald-market' => [
                'global_primary' => '#047857',
                'global_secondary' => '#064e3b',
                'global_accent' => '#f59e0b',
                'global_success' => '#15803d',
                'global_warning' => '#d97706',
                'global_danger' => '#dc2626',
                'global_info' => '#0891b2',
                'global_neutral_dark' => '#14352b',
                'global_neutral_light' => '#ecfdf5',
                'global_page_background' => '#f7fdf9',
                'global_body_text' => '#14352b',
                'global_body_muted' => '#587269',
                'global_heading' => '#065f46',
                'global_link' => '#047857',
                'global_link_hover' => '#d97706',
                'global_border' => '#bbf7d0',
            ],
            'royal-purple' => [
                'global_primary' => '#6d28d9',
                'global_secondary' => '#3b0764',
                'global_accent' => '#f59e0b',
                'global_success' => '#16a34a',
                'global_warning' => '#d97706',
                'global_danger' => '#dc2626',
                'global_info' => '#7c3aed',
                'global_neutral_dark' => '#2e2140',
                'global_neutral_light' => '#f3e8ff',
                'global_page_background' => '#faf7ff',
                'global_body_text' => '#2e2140',
                'global_body_muted' => '#746682',
                'global_heading' => '#5b21b6',
                'global_link' => '#6d28d9',
                'global_link_hover' => '#d97706',
                'global_border' => '#ddd6fe',
            ],
            'crimson-shop' => [
                'global_primary' => '#be123c',
                'global_secondary' => '#4c0519',
                'global_accent' => '#f97316',
                'global_success' => '#15803d',
                'global_warning' => '#f59e0b',
                'global_danger' => '#b91c1c',
                'global_info' => '#0284c7',
                'global_neutral_dark' => '#3f1722',
                'global_neutral_light' => '#ffe4e6',
                'global_page_background' => '#fff7f8',
                'global_body_text' => '#3f1722',
                'global_body_muted' => '#81616a',
                'global_heading' => '#9f1239',
                'global_link' => '#be123c',
                'global_link_hover' => '#ea580c',
                'global_border' => '#fecdd3',
            ],
            'amber-night' => [
                'global_primary' => '#92400e',
                'global_secondary' => '#292524',
                'global_accent' => '#f59e0b',
                'global_success' => '#15803d',
                'global_warning' => '#d97706',
                'global_danger' => '#dc2626',
                'global_info' => '#0369a1',
                'global_neutral_dark' => '#292524',
                'global_neutral_light' => '#fef3c7',
                'global_page_background' => '#fffbeb',
                'global_body_text' => '#292524',
                'global_body_muted' => '#78716c',
                'global_heading' => '#78350f',
                'global_link' => '#92400e',
                'global_link_hover' => '#d97706',
                'global_border' => '#fde68a',
            ],
            'rose-boutique' => [
                'global_primary' => '#be185d',
                'global_secondary' => '#500724',
                'global_accent' => '#a855f7',
                'global_success' => '#15803d',
                'global_warning' => '#d97706',
                'global_danger' => '#dc2626',
                'global_info' => '#7e22ce',
                'global_neutral_dark' => '#3f172f',
                'global_neutral_light' => '#fce7f3',
                'global_page_background' => '#fff7fb',
                'global_body_text' => '#3f172f',
                'global_body_muted' => '#806377',
                'global_heading' => '#9d174d',
                'global_link' => '#be185d',
                'global_link_hover' => '#9333ea',
                'global_border' => '#fbcfe8',
            ],
            'teal-studio' => [
                'global_primary' => '#0f766e',
                'global_secondary' => '#134e4a',
                'global_accent' => '#e11d48',
                'global_success' => '#15803d',
                'global_warning' => '#d97706',
                'global_danger' => '#be123c',
                'global_info' => '#0891b2',
                'global_neutral_dark' => '#173b39',
                'global_neutral_light' => '#ccfbf1',
                'global_page_background' => '#f0fdfa',
                'global_body_text' => '#173b39',
                'global_body_muted' => '#5f7774',
                'global_heading' => '#115e59',
                'global_link' => '#0f766e',
                'global_link_hover' => '#be123c',
                'global_border' => '#99f6e4',
            ],
            'graphite-lime' => [
                'global_primary' => '#334155',
                'global_secondary' => '#0f172a',
                'global_accent' => '#84cc16',
                'global_success' => '#16a34a',
                'global_warning' => '#eab308',
                'global_danger' => '#dc2626',
                'global_info' => '#0ea5e9',
                'global_neutral_dark' => '#1e293b',
                'global_neutral_light' => '#f1f5f9',
                'global_page_background' => '#f8fafc',
                'global_body_text' => '#1e293b',
                'global_body_muted' => '#64748b',
                'global_heading' => '#1e293b',
                'global_link' => '#334155',
                'global_link_hover' => '#65a30d',
                'global_border' => '#cbd5e1',
            ],
            'warm-sand' => [
                'global_primary' => '#9a3412',
                'global_secondary' => '#431407',
                'global_accent' => '#0d9488',
                'global_success' => '#15803d',
                'global_warning' => '#d97706',
                'global_danger' => '#dc2626',
                'global_info' => '#0284c7',
                'global_neutral_dark' => '#422b20',
                'global_neutral_light' => '#ffedd5',
                'global_page_background' => '#fffbf5',
                'global_body_text' => '#422b20',
                'global_body_muted' => '#7c685d',
                'global_heading' => '#9a3412',
                'global_link' => '#9a3412',
                'global_link_hover' => '#0f766e',
                'global_border' => '#fed7aa',
            ],
        ];
    }
    ...
    {
        $legacyPresetAliases = [
            'lucent-tech-bd' => 'default',
            'modern-blue' => 'ocean-blue',
            'blue-orange' => 'default',
            'dark-technology' => 'graphite-lime',
            'light-technology' => 'ocean-blue',
            'minimal' => 'graphite-lime',
        ];
        if (isset($theme['preset']) && is_string($theme['preset']) && isset($legacyPresetAliases[$theme['preset']])) {
            $theme['preset'] = $legacyPresetAliases[$theme['preset']];
        }
    ...
    public function cssVariables(array $theme): array
    {
        ...
        return [
            ...
            '--theme-detail-code-font-family' => $font($resolved['detail_code_font_family'], 'inherit'),
            '--theme-detail-code-font-size' => (int) $resolved['detail_code_font_size'].'px',
            '--theme-detail-code-font-weight' => (int) $resolved['detail_code_font_weight'],
            ...
            '--theme-detail-code-border-width' => (int) $resolved['detail_code_border_width'].'px',
            '--theme-detail-code-radius' => (int) $resolved['detail_code_border_radius'].'px',
            '--theme-detail-code-padding-y' => (int) $resolved['detail_code_padding_y'].'px',
            '--theme-detail-code-padding-x' => (int) $resolved['detail_code_padding_x'].'px',
